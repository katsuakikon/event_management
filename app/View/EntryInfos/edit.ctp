...
<?php echo $this->Form->create('EntryInfo'); ?>
	<fieldset>
		<legend><?php echo __('参加者編集'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('削除'), array('action' => 'delete', $this->Form->value('EntryInfo.id')), array(), __('次のIDの参加者を本当に削除しますか # %s?', $this->Form->value('EntryInfo.id'))); ?></li>
