...
<?php echo $this->Form->create('EntryInfo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entry Info'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EntryInfo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EntryInfo.id'))); ?></li>
